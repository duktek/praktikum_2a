...
\begin{enumerate}
    ...
    Dengan list :
    \lstinputlisting[firstline=11, lastline=21]{src/1174027/c_1174027_csv.py}
    Dengan dictionary :
  	\lstinputlisting[firstline=24, lastline=33]{src/1174027/c_1174027_csv.py}
    Kedua,fungsi menulis file csv.
    \lstinputlisting[firstline=36, lastline=40]{src/1174027/c_1174027_csv.py}
	...
	\lstinputlisting[firstline=10, lastline=11]{src/1174027/p_1174027_pandas.py}
	\item Bukti Bebas Plagiat
	\begin{figure}[H]
		\centering
		\includegraphics[width=10cm]{figures/harunpla.png}
